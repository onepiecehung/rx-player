 ...
 * @type {Object}
 */
const TEXT_ALIGN_TO_LIGN_ALIGN : { [key : string] : string } = {
  left: "start",
  center: "center",
  right: "end",
  start: "start",
 ...
 * @type {Object}
 */
const TEXT_ALIGN_TO_POSITION_ALIGN : { [key : string] : string } = {
  left: "line-left",
  center: "center",
  right: "line-right",
};

function parseTTMLStringToVTT(str : string) : VTTCue[] {
  const ret : VTTCue[] = [];
 ...
 */
function addNewLines(element : Node, whitespaceTrim : boolean) : void {
