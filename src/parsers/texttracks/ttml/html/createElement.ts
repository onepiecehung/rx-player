...
import ttmlColorToCSSColor from "./ttmlColorToCSSColor";
...
function applyTextStyle(
  element : HTMLElement,
  elementsToInherit : Element[],
  styles : Element[],
  regions : Element[]
) : void {
  function getInheritedStyle(styleName : string) {
...
function generateTextContent(
  ...
  function loop(_paragraph : Element|Node) : Element[] {
...
export default function createElement(
  ...
  regions : Element[],
  styles : Element[],
  { shouldTrimWhiteSpace = true } : { shouldTrimWhiteSpace? : boolean } = {}
) {
